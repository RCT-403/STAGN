...
parser.add_argument('--model_file', default='./Results_STE/model_parameters.pkl', # CHANGE TO WHATEVER FOLDER
                    help='save the model to disk')
parser.add_argument('--log_file', default='./Results_STE/log', # CHANGE TO WHATEVER FOLDER
                    help='log file')
...
model = STE_GMAN(SE, args, bn_decay=0.1)         # CHANGE THE MODEL ALSO 
...
if __name__ == '__main__':
    ...
    plot_train_val_loss(loss_train, loss_val, 'Results_STE/train_loss.png', 'Results_STE/val_loss.png', "Results_STE/loss.txt" ) # CHANGE TO WHATEVER FOLDER
