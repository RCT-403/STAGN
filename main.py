...
parser.add_argument('--model_file', default='./Results_GMAN/model_parameters2.pkl', # CHANGE TO WHATEVER FOLDER
                    help='save the model to disk')
parser.add_argument('--log_file', default='./Results_GMAN/log2', # CHANGE TO WHATEVER FOLDER
                    help='log file')
...
if __name__ == '__main__':
    ...
    plot_train_val_loss(loss_train, loss_val, 'Results_GMAN/train_loss2.png', 'Results_GMAN/val_loss2.png', "Results_GMAN/loss2.txt" ) # CHANGE TO WHATEVER FOLDER
