...
parser.add_argument('--model_file', default='./Results_Kmeans/GMAN_STE.pkl', # CHANGE TO WHATEVER FOLDER
                    help='save the model to disk')
parser.add_argument('--log_file', default='./Results_Kmeans/log_STE', # CHANGE TO WHATEVER FOLDER
                    help='log file')
